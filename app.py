...
app.layout = html.Div([
    ...
    html.P("My website for following the World Cup, inspired by Google's World Cup widget, ESPN's website, and FIFA's website.", style={"fontFamily": "Inter, sans-serif"}),
